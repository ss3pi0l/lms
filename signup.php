...
<style type="text/css">
	#main_content{
		padding: 50px;
		background-color: rgb(76, 61, 61, 0.6);
		...
		<div class="col-md-8" id="main_content">
			...
			<form action="register.php" method="post">
				...
				<div class="form-group">
					...
					<input type="password" name="password" class="form-control" required minlength="8" maxlength="24">
				</div>
				<div class="form-group">
					<label for="mobile">Mobile:</label>
					<input type="number" name="mobile" class="form-control" required max="9999999999" min="1111111111">
				</div>
				<div class="form-group">
